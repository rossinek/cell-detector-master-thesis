...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item[$\circ$] \texttt{skeleton} -- implementacja poszczególnych kroków pluginu opisana w tej pracy (oparta na szkieletyzacji)
  \end{itemize}
  \item \texttt{graph} -- implementacja grafu
  \item \texttt{gui} -- implementacje okien i komponentów interfejsu
...
\ldots % TODO Główny plugin i interfejsy, możliwość podmiany dowolnego kroku pluginu
