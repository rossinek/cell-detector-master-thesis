...
\polishabstract {
Gruźlica i inne choroby powodowane przez bakterie z rodzaju Mycobacterium są wciąż poważnym problemem w wielu miejscach świata.
...
Jedną z istotnych części tego typu badań jest proces pozyskiwania danych z nagrań spod mikroskopu przedstawiających cykl komórkowy komórek modelowych.
...
This type of research are one of the issues they deal with.
One of the main parts of their research is the process of obtaining data from microscopic recordings of the cell cycle of model organisms.
...
Zwrócony przez przez metodę \texttt{init} komponent zostanie automatycznie umieszczony w oknie pluginu.
