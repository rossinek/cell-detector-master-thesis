...
\begin{figure}[h]
  \centering
  \includegraphics[valign=m,width=0.3\textwidth]{images/overlap-pwv.png}
  $\rightarrow$
  \includegraphics[valign=m,width=0.3\textwidth]{images/overlap-pwv-solved.png}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[valign=m,width=0.3\textwidth]{images/overlap-p.png}
  $\rightarrow$
  \includegraphics[valign=m,width=0.3\textwidth]{images/overlap-p-solved.png}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[valign=m,width=0.3\textwidth]{images/overlap-f.png}
  $\rightarrow$
  \includegraphics[valign=m,width=0.3\textwidth]{images/overlap-f-solved.png}
\end{figure}
